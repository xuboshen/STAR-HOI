...
# from hoid_model.nms.nms_wrapper import nms
...
if __name__ == "__main__":
    ...
    load_name = os.path.join(
        "../checkpoints/faster_rcnn_{}_{}_{}.pth".format(
    ...
    with torch.no_grad():
        ...
        while num_images >= 0:
            ...
            # bgr
            im = im_in  # 1031, 1361, 3, ego4d demo
            ...
            lr_vector = loss_list[2][
                0
            ].detach()  # hand side info (left/right) # [1, 300, 1]

            # get hand contact
            _, contact_indices = torch.max(contact_vector, 2)
            contact_indices = (
                contact_indices.squeeze(0).unsqueeze(-1).float()
            )  # [300, 1]
            ...
            if cfg.TEST.BBOX_REG:
                ...
                if cfg.TRAIN.BBOX_NORMALIZE_TARGETS_PRECOMPUTED:
                    # Optionally normalize targets by a precomputed mean and stdev, default is false
            ...
            for j in xrange(1, len(pascal_classes)):
                ...
                if pascal_classes[j] == "hand":
                    ...
                    # j == 1
                    inds = torch.nonzero(scores[:, j] > thresh_obj).view(-1)  # (9, )
                ...
                if inds.numel() > 0:
                    ...
                    keep = nms(
                        cls_boxes[order, :], cls_scores[order], cfg.TEST.NMS
                    )  # indices: [0, 2], 有两个物体
